...
package body TASTE.Dump is
   ...
   begin
      if Model.Deployment_View.Is_Empty then
         Put_Info ("No Deployment View - Dump content may be incomplete");
      end if;
      ...
      while More_Entries (ST) loop
         ...
         declare
            ...
            Trigger       : constant Boolean :=
              (Check and then
                 (String'(Strip_String
                     (Parse (Trig_Template, Trig_Tmpl))) = "TRUE"));
         ...
         begin
            if not Check or not Trigger then
               ...
               if not Model.Deployment_View.Is_Empty then
                  for N of Model.Deployment_View.Element.Nodes loop
                     ...
                     begin
                        ...
                        Node_Map :=
                            Node_Map & Assoc ("Partitions", Partitions);
